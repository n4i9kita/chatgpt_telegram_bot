...
async def start_handle(update: Update, context: CallbackContext):
    ...
    reply_text = "Hi! I'm <b>InterviewPrepBot</b> implemented with OpenAI API 🤖\n\n"
...
async def unsupport_message_handle(update: Update, context: CallbackContext, message=None):
    error_text = f"I don't know how to read images, videos or files. Send text or audio messages."
    logger.error(error_text)
    await update.message.reply_text(error_text)
    return
...
async def voice_message_handle(update: Update, context: CallbackContext):
    ...
    text = f"Just to confirm, here’s what I heard 🎧"
...
async def edited_message_handle(update: Update, context: CallbackContext):
    if update.edited_message.chat.type == "private":
        text = "🚫 Sorry, message editing isn't supported. Need help with anything else?"
